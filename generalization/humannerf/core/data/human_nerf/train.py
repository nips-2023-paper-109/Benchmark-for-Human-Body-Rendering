...
class Dataset(torch.utils.data.Dataset):
    def __init__(
        ...
        ## self.motion_weights_priors.shape = (25, 32, 32, 32)
    ...
    def __getitem__(self, idx):
        ...
        ## 相机是固定的，但每一帧人都在动
        ## 按照论文的描述，ray-casting也是要在canonical space下进行
        ## 这就意味着相机在cononical space下是绕着人在旋转的
        ## 相当于人只运动了四肢，没有空间中的位移和旋转
        ## 极大地简化了问题… （有点儿6）
        ...
        if 'motion_bases' in self.keyfilter:
            ## dst_Rs, rotation matrices (joint to joint)
            ## dst_Ts, translation (joint to joint)
