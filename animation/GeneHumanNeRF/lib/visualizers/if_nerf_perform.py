...
class Visualizer:
    ...
    def visualize(self, output, batch):
        ...
        subject = (cfg.train_dataset.data_root).split('/')[-1]
        frame_root = 'data/pose_sequence/{}/{}'.format(
            cfg.exp_name, subject)
        ...
        cv2.imwrite(os.path.join(frame_root, 'frame{:04d}_normal.png'.format(frame_index)),
                    normal_pred * 255)
